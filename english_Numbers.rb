# Writing a self-method that can return values from zero to thousand's in
# english numbers.
...
def english_number number
    ...
    if write > 0
        if ((write == 1) and (left > 0))
            ...
            # with teens the digit in the ones place is taken care
            # of so nothing left
            left = 0
        else
...
puts english_number( 999986)
puts english_number( 1094347543754637)
